    ...
    <div class="cat-side-flexible-body">
        <transition :name="`slide-flex-${direction}`">
            <cc-row 
                ...
                <cc-row 
                    ...
                    <i class="iconfont_calico cat-side-flexible--icon" :class="`icon_calico-open-takeup-${direction}`"></i>
                </cc-row>
                <div>
                    <slot></slot>
                </div>
        ...
        <transition :name="`slide-flex-${direction}`">
            <cc-row 
                ...
                <i class="iconfont_calico cat-side-flexible--icon" :class="`icon_calico-open-takeup-${directionIcon[direction]}`"></i>
